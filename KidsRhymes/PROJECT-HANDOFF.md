...
- Felix production has started under `metadata/felix-firefly-night-light-parade-01-plan.json`. Four premium 1672x941 scenes are accepted and hash-locked in `metadata/felix-firefly-night-light-parade-01-asset-review.json`: corrected three-lantern opening, Rabbit's physical gold-blue-gold route, Hedgehog's blue-gold-blue route and the wind-covered memory complication. The first opening generation was rejected for an extra lantern and is not a project asset. Nothing is rendered, queued or uploaded yet; scenes 5-8, producer, soundtrack, pacing audit, all final quality evidence and thumbnail remain pending.
