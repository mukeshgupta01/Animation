...
## Dad welcome rhythm visual checkpoint (2026-08-28)

- `dads-coming-home-welcome-rhythm-01` now has a locked 88-second / 96 BPM inclusive musical-story plan and seven reviewed 1672x941 stop-motion-inspired paper-and-fabric apartment scenes. Preserve the exact Mina/Dad identities, teal/coral/honey room, rounded doorway, window light progression and files recorded in `metadata/dads-coming-home-welcome-rhythm-01-plan.json` and `metadata/dads-coming-home-welcome-rhythm-01-asset-review.json`.
...
- Natasha remains lead, with Maisie as Mina and Ryan as Dad. The producer and synchronized musical soundtrack are next; nothing is queued or uploaded.
