...
- This is an approved local extension foundation only. It has no upload sidecar, is not in the curated manifest or pending queue, and must not be uploaded until a full Tiny Tales episode receives the normal visual, audio, thumbnail and upload-safeguard review.
