...
- The next varied set is locked in `metadata/new-video-batch-plan-2026-08-28-c.json`: Eddie Excavator (`ana-us`), Dad's Coming-Home Welcome Rhythm (`natasha-au`) and Pick/Wash/Pack Fruit Picnic (`maisie-uk`). Eddie is active with accepted anchor `automation/production-assets/eddie-excavator-rain-garden-opening-v1.png`; preserve its character, realistic machine joints, rain-garden goal and fenced child safety in later scenes.
